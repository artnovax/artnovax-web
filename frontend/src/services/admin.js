...
import { getAboutPageContent, getAppPageContent, getEventsPageContent, getGetInvolvedPageContent, getHomePageContent, getOurWorkPageContent, getResearchPageContent, saveAboutPageContent, saveAppPageContent, saveEventsPageContent, saveGetInvolvedPageContent, saveHomePageContent, saveOurWorkPageContent, saveResearchPageContent } from './pageContent';
...
export async function loadAdminDashboard() {
  const [subscribers, newsletters, waitlist, messages, events, articles, products, registrations, applicationsRaw, inquiries, roles, founders, homePage, aboutPage, ourWorkPage, eventsPage, researchPage, appPage, getInvolvedPage] = await Promise.all([
  ...
  return { subscribers, newsletters, waitlist, messages, events, articles, products, registrations, applications, inquiries, roles, founders, homePage, aboutPage, ourWorkPage, eventsPage, researchPage, appPage, getInvolvedPage };
}
...
export const saveAppPage = (payload) => saveAppPageContent(payload);
