...
import { getAboutPageContent, getEventsPageContent, getHomePageContent, getOurWorkPageContent, saveAboutPageContent, saveEventsPageContent, saveHomePageContent, saveOurWorkPageContent } from './pageContent';
...
export async function loadAdminDashboard() {
  const [subscribers, newsletters, waitlist, messages, events, articles, products, registrations, applicationsRaw, inquiries, roles, founders, homePage, aboutPage, ourWorkPage, eventsPage] = await Promise.all([
  ...
  return { subscribers, newsletters, waitlist, messages, events, articles, products, registrations, applications, inquiries, roles, founders, homePage, aboutPage, ourWorkPage, eventsPage };
}
