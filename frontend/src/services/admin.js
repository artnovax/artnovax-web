...
export async function loadAdminDashboard() {
  const [subscribers, newsletters, waitlist, messages, events, articles, products, registrations, applicationsRaw, inquiries, roles, founders, homePage, aboutPage, ourWorkPage, eventsPage, researchPage, appPage, getInvolvedPage, contactPage, shopPage, supportPage, volunteerPage] = await Promise.all([
  ...
  return { subscribers, newsletters, waitlist, messages, events, articles, products, registrations, applications, inquiries, roles, founders, homePage, aboutPage, ourWorkPage, eventsPage, researchPage, appPage, getInvolvedPage, contactPage, shopPage, supportPage, volunteerPage };
}
