...
const TabletMock = () => (
  <div className="relative w-full max-w-[560px] mx-auto">
    ...
    <svg
      viewBox="0 0 200 200"
      className="absolute -left-6 top-8 w-20 h-20 text-burgundy/70 -rotate-12"
      fill="currentColor"
    >
      <path
        d="M40 100c20-40 60-70 120-60-20 60-70 100-120 60z"
        opacity="0.55"
      />
    </svg>
    <svg
      viewBox="0 0 200 200"
      className="absolute -right-8 bottom-2 w-24 h-24 text-burgundy/60 rotate-12"
      fill="currentColor"
    >
    ...
    <div className="relative rounded-[26px] bg-neutral-900 p-2 shadow-[0_30px_60px_-24px_rgba(0,0,0,0.35)]">
      <div className="rounded-[20px] bg-ivory p-4 aspect-[4/3] overflow-hidden">
        <div className="text-[15px] font-serif-display text-ink flex items-center gap-1">
          Good morning, Shiro <span className="text-amber-500">✨</span>
        </div>
        ...
        <div className="mt-3 rounded-xl bg-ivory-100 ring-1 ring-ivory-300 p-3">
          <div className="text-[10px] tracking-widest text-ink/60">
            Continue Your Journey
          </div>
          <div className="grid grid-cols-[1fr_auto] gap-2 items-center mt-1">
            <div>
              <div className="font-serif-display text-burgundy text-[15px] font-semibold">
                Grounding Through Color
              </div>
              <div className="text-[10px] text-ink/60">
                Step 2 of 5 • 6 min left
              </div>
              <button className="mt-2 text-[10.5px] rounded-md bg-burgundy text-ivory px-2.5 py-1 font-semibold">
                Continue Session
              </button>
            </div>
        ...
        <div className="mt-3 flex items-center justify-between">
          <div className="text-[10.5px] font-semibold text-ink/70">
            Recommended For You
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 mt-1">
          {[
            ["from-green-200", "to-emerald-400", "Soothing Lines", "10 min"],
            ["from-orange-200", "to-rose-400", "Poetic Doodles", "8 min"],
            ["from-amber-200", "to-red-400", "Ubuntu Flow", "8 min"],
          ].map((c, i) => (
            <div
              key={i}
              className="rounded-lg overflow-hidden ring-1 ring-ivory-300"
            >
              <div className={`h-10 bg-gradient-to-br ${c[0]} ${c[1]}`} />
              <div className="px-1.5 py-1">
                <div className="text-[9.5px] font-semibold text-ink truncate">
                  {c[2]}
                </div>
        ...
        <div className="mt-3 flex items-center justify-around border-t border-ivory-300 pt-1.5 text-[8.5px] text-ink/60">
          ...
          <div className="flex flex-col items-center gap-0.5 text-ink/50">
            <div className="w-3 h-3 rounded-full ring border" />
            Sessions
          </div>
          <div className="flex flex-col items-center gap-0.5 text-ink/50">
...
const AppPage = () => {
  ...
  return (
    <div className="min-h-screen bg-ivory">
      ...
      <section
        id="features"
        className="mx-auto max-w-[1180px] px-4 md:px-8 pt-10 md:pt-16"
      >
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {APP.features.map((f) => (
            <div key={f.title} className="text-center">
              ...
              <h3 className="mt-3 font-serif-display text-ink text-[15px] font-semibold">
                {f.title}
              </h3>
              <p className="mt-1 text-[12.5px] text-ink/70 leading-snug">
                {f.body}
              </p>
            </div>
          ))}
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-[minmax(0,2.4fr)_minmax(0,1fr)] gap-8 items-start">
            ...
            {APP.steps.map((s, i) => (
              <React.Fragment key={s.title}>
                <div className="flex flex-col items-center text-center max-w-[160px]">
                  ...
                  <p className="mt-1 text-[12px] text-ink/70 leading-snug">
                    {s.body}
                  </p>
                </div>
          ...
          <div className="rounded-3xl bg-ivory-200/70 ring-1 ring-ivory-300 p-5 md:p-6 relative overflow-hidden">
            ...
            <div className="mt-4 relative h-32">
              <svg
                viewBox="0 0 240 140"
                className="absolute right-2 bottom-0 w-40 h-32"
              >
                <ellipse
                  cx="140"
                  cy="120"
                ...
                />
                <path
                  d="M120 60c-10 0-18 8-18 18v30h36V78c0-10-8-18-18-18z"
                  fill="#E88A82"
                />
                <circle cx="120" cy="48" r="14" fill="#3E2A2A" />
                <path
                  d="M108 42c0-8 6-14 12-14s12 6 12 14c0 4-2 8-6 10-2-2-4-4-6-4s-4 2-6 4c-4-2-6-6-6-10z"
                  fill="#2A1B1C"
                />
                <path
                  d="M114 92c2 4 10 4 12 0"
                  stroke="#2A1B1C"
                  strokeWidth="1.5"
                  fill="none"
                  strokeLinecap="round"
